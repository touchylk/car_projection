    ...
    def __init__(self, net, data):
        ...
        for i in range(len(self.variable_to_restore)):
            ...
            with open(self.train_process_save_txt_file, 'a') as f:
                f.writelines('{}\n{}\n'.format(self.restore_name[i].op.name,
                                               self.variable_to_restore[self.restore_name[i].op.name]))
        ...
        print('pass')
        self.ckpt_file = self.weights_to_save # sos.path.join(self.weights_to_save, 'save.ckpt')
    ...
    def train(self):
        ...
        for step in xrange(1, self.max_iter + 1):
            ...
            if step % self.save_iter == 0:
                print('Saving checkpoint file to:{}'.format(self.ckpt_file))
